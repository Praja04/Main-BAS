...
<script>
    $(document).ready(function() {
        ...
        $("#apply-filter").click(function() {
            ...
            if (mode === "normal") {
                getDailytankData("http://10.11.11.200/mybas/public/api/daily-tank/data");
            } else if (mode === "harian") {
                ...
                getDailytankData("http://10.11.11.200/mybas/public/api/daily-tank/data-harian", {
                    tanggal: tanggal
                });
            } else if (mode === "mingguan") {
                ...
                getDailytankData("http://10.11.11.200/mybas/public/api/daily-tank/data-mingguan", {
