...
<script>
    $(document).ready(function() {
        ...
        function updateChart(data) {
            ...
            let seriesData = [{
                    name: "GST01",
                    data: data.map(item => item.GST1)
                },
                {
                    name: "GST02",
                    data: data.map(item => item.GST2)
                },
                {
                    name: "GST03",
                    data: data.map(item => item.GST3)
                },
                {
                    name: "GST04",
                    data: data.map(item => item.GST4)
                },
                {
                    name: "GST05",
                    data: data.map(item => item.GST5)
                }
            ];
        ...
        $("#apply-filter").click(function() {
            ...
            if (mode === "normal") {
                getGlucoseData("http://10.11.11.200/mybas/public/api/glucose/data");
            } else if (mode === "harian") {
                ...
                getGlucoseData("http://10.11.11.200/mybas/public/api/glucose/data-harian", {
                    tanggal: tanggal
                });
                ...
                getGlucoseData("http://10.11.11.200/mybas/public/api/glucose/data-mingguan", {
