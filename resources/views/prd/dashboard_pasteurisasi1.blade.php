...
<script>
    $(document).ready(function() {
        ...
        function handleFilterClick(prefix = "") {
            ...
            if (filter === "latest") {
                url = "http://10.11.11.200/mybas/public/pasteurisasi1/data";
                ...
                url = "http://10.11.11.200/mybas/public/pasteurisasi1/data-harian";
                params = {
                ...
                url = "http://10.11.11.200/mybas/public/pasteurisasi/data-mingguanhttp://10.11.11.200/mybas/public/";
                params = {
                    tanggal_mulai: start,
                    tanggal_selesai: end
                };
        ...
        function updateRealtimeInfo() {
            fetchData("http://10.11.11.200/mybas/public/pasteurisasi1/data-realtime").done(res => {
                if (res.SpeedPompaMixing !== undefined && res.SpeedPompaMixing !== null) {
                    updateGaugeChart(res);
                }
            }).fail(handleAjaxError);

            fetchData("http://10.11.11.200/mybas/public/prd/data/status-running").done(res => {
        ...
        function fetchDataAbnormal(filter = 'today', start = '', end = '') {
            const endpoints = [{
                    url: 'http://10.11.11.200/mybas/public/pasteurisasi1/suhuholding',
                    target: '#suhuholding_abnormal'
                },
                {
                    url: 'http://10.11.11.200/mybas/public/pasteurisasi1/suhuheating',
                    target: '#suhuheating_abnormal'
                },
                {
                    url: 'http://10.11.11.200/mybas/public/pasteurisasi1/flowrate',
